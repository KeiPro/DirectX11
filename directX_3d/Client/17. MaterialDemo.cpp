...
{	
	...
	// Material
	{
		...
		RESOURCES->Add(L"Orianna", material);
	}
	...
	{
		auto material = RESOURCES->Get<Material>(L"Orianna");
	...
	{
		auto material = RESOURCES->Get<Material>(L"Orianna")->Clone();
		MaterialDesc& desc = material->GetMaterialDesc();
		desc.ambient = Color(1.0f, 0.0f, 0.0f, 1.0f);
...
void MaterialDemo::Update()
{
...

	{
		...
		desc.diffuse = Vec4(1.f);
		//desc.specular = Color(0.5f, 0.5f, 0.5f, 1.0f);
